define([
  ...
  var ThemeView = Backbone.View.extend({
    ...
    setBackgroundColor: function() {
      var backgroundColor = this.model.get("_backgroundColor");

      if (!backgroundColor || !backgroundColor._isEnabled) return;

      this.$el.css("background-color", backgroundColor._color);
      this.$el.css("color", backgroundColor._fontColor);
      this.$el.find('.component__title').css("color", backgroundColor._fontColor);
    },
